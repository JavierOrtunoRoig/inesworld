...
export const ui = {
	en: {
		...
		"why_me.reason_1.description":
			"I believe there are stories that have the power to change the world. My goal is to give voice through photography and filmmaking to all those realities who have the potential to inspire change.",

		"why_me.reason_2.title": "Community and Nature",
		"why_me.reason_2.description":
			"They are the pillars of my work. I aim for its preservation, striving to promote projects which improve the quality of life of the communities and protect the world we live in.",
		...
		"about_section_1.text_1":
			"My story begins in the south of Spain, in Málaga. There was a young girl who discovered the world from home, thanks to creators who brought her different cultures and realities when she couldn't explore them by  herself.",
		"about_section_1.text_2":
			"From that moment, I knew I wanted to do what I saw on tv: tell stories. So, my curiosity led me to explore the world with my camera, aiming to document these realities and making you feel the world.",

		"about_section_2.title": "The Journey",
		"about_section_2.text_1":
			"Before venturing into the world to explore it on my own, I trained in filmmaking, photography, and media, accumulating professional experience as a camera operator and editor with film and theater companies like Krakow Film Klaster and Soho Theatre Caixa Bank. As a freelancer, I have worked for musical artists and influencers who have garnered hundreds of thousands of views and followers. Additionally, I have created documentaries for organizations dedicated to making a positive social impact.",
		"about_section_2.text_2":
			"This experience has shaped my vision and equipped me with the tools needed to give a voice to those incredible stories that deserve to be told, in order to connect people from all over the world and foster empathy for their realities.",
	...
	es: {
		...
		"about_section_1.title": "Mi historia",
		"about_section_1.text_1":
